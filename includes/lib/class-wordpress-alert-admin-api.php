 ...
 * Admin API class.
 */
class WordPress_Plugin_alert_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'wordpress-alert' ) . '" data-uploader_button_text="' . __( 'Use image', 'wordpress-alert' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'wordpress-alert' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'wordpress-alert' ) . '" />' . "\n";
